...
namespace WarGrey::SCADA {
	...
	public:
		void on_timestream(long long time_ms, size_t addr0, size_t addrn, uint8* data, size_t size, uint64 parcel_type, size_t parcel_size, WarGrey::SCADA::Syslog* logger) override;
