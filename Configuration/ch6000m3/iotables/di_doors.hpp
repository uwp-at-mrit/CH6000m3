...
namespace WarGrey::SCADA {
	...
	static unsigned int bottom_doors_locked = 1086U;
	static unsigned int bottom_doors_auto_lock = 1087U;
	...
	/************************************************************************************************/
	bool DI_hopper_doors_auto_lock(const uint8* db205);
	bool DI_hopper_doors_locked(const uint8* db205);
}
