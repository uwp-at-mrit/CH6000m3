...
bool WarGrey::SCADA::DI_hopper_pump_running(const uint8* db4, size_t idx4_p1) {
	return DI_hopper_pump_running(db4, idx4_p1, DI_hopper_type(db4, idx4_p1) || DI_underwater_type(db4, idx4_p1));
}
