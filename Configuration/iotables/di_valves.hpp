...
namespace WarGrey::SCADA {
	...
	bool DI_gate_value_opening(const uint8* db205, size_t idx_p1);
	bool DI_gate_value_closing(const uint8* db205, size_t idx_p1);
	bool DI_gate_value_moving(const uint8* db205, size_t idx_p1);
}
