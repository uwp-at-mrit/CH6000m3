...
namespace WarGrey::SCADA {
	...
	static unsigned int ps_compensator_details = 1521U;
	static unsigned int sb_compensator_details = 1537U;
	static unsigned int ps_visor_details = 1553U;
	static unsigned int sb_visor_details = 1561U;
	...
	bool DI_gantry_pushing_out(const uint8* db205, unsigned int idx205_p1);
	bool DI_gantry_pulling_in(const uint8* db205, unsigned int idx205_p1);
	bool DI_gantry_moving(const uint8* db205, unsigned int idx205_p1);

	bool DI_compensator_working(const uint8* db205, unsigned int idx205_p1);
	bool DI_visor_curling(const uint8* db205, unsigned int idx205_p1);
